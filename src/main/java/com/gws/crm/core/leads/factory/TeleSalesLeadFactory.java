...
@Slf4j
public class TeleSalesLeadFactory {
    ...
    public TeleSalesLead mapDtoToEntity(AddLeadDTO leadDTO, Transition transition) {
    ...
    public void updateEntityFromDto(TeleSalesLead entity, AddLeadDTO leadDTO, Transition transition) {
...
*/
    ...
    public List<TeleSalesLead> createLeadsList(List<ImportLeadDTO> importLeadDTOS, Transition transition) {
