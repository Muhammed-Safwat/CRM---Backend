...
public class PreLeadSpecification {
    ...
    private static Specification<PreLead> filterByDelayed(Boolean delayed) {
        return (root, query, criteriaBuilder) -> {
            if (delayed == null) {
                return null;
            }
    ...
    private static Specification<PreLead> filterByImported(Boolean imported) {
        return (root, query, criteriaBuilder) -> {
            ...
            return criteriaBuilder.equal(root.get("imported"), imported);
        };
    }
